...
insert into HANGGIAY (tenHangGiay) values ('Nike');
insert into HANGGIAY (tenHangGiay) values ('Addidas');
insert into HANGGIAY (tenHangGiay) values ('Vans');
insert into HANGGIAY (tenHangGiay) values ('Converse');
insert into HANGGIAY (tenHangGiay) values ('Fila');
go
...
insert into HOADON(idNV, idKH) values(1, 1);
go
