...
CREATE VIEW v_TenSP
AS
	SELECT LOAISP.MALOAISP, TENSP, LOAISP.TENLOAISP
	FROM SANPHAM, LOAISP
...
--View 2: Hiển thị thông tin các sản phẩm đã bán được
GO 
...
--View 3: Hiển thị thông tin khách hàng theo Đơn hàng họ đã đặt
GO
...
--View 4: Hiển thị thông tin các sản phẩm có mặt trong từ 5 Đơn hàng trở lên
GO
...
--View 5: Hiển thị thông tin Loại Sản phẩm
GO
...
--View 6: Hiển thị thông tin Đơn hàng theo giá giảm dần
GO
...
--View 7: Hiển thị thông tin Chi tiết đơn hàng 
GO
